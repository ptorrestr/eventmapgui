...
(function() {
  window.$(function() {
    window.$.setAjaxPagination = function() {
      return $('.pagination a').click(function(event) {
        var loading;
        event.preventDefault();
        loading = $('<div id="loading" style="display: none;"><span><img src="/assets/loading.gif" alt="Loading..."/></span></div>');
    ...
    return window.$.setAjaxPagination();
  });
